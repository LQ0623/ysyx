...
VL_ATTR_COLD void Vysyx_24100006_cpu___024root__trace_init_sub__TOP__0(Vysyx_24100006_cpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+47,"x_pc", false,-1, 31,0);
    ...
    tracep->declBus(c+4,"npc", false,-1, 31,0);
    tracep->declBus(c+5,"instruction", false,-1, 31,0);
    tracep->declBit(c+48,"wen", false,-1);
    tracep->declBus(c+6,"rs", false,-1, 4,0);
    tracep->declBus(c+7,"rt", false,-1, 4,0);
    tracep->declBus(c+49,"rd", false,-1, 4,0);
    tracep->declBus(c+8,"waddr", false,-1, 4,0);
    tracep->declBus(c+46,"wdata", false,-1, 31,0);
    tracep->declBus(c+9,"rs1_data", false,-1, 31,0);
    tracep->declBus(c+10,"rs2_data", false,-1, 31,0);
    tracep->declBus(c+11,"sext_imm", false,-1, 31,0);
    ...
    tracep->declBus(c+9,"rs_data", false,-1, 31,0);
    tracep->declBus(c+11,"rt_data", false,-1, 31,0);
    tracep->declBus(c+46,"rd_data", false,-1, 31,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vysyx_24100006_cpu___024root__trace_full_sub_0(Vysyx_24100006_cpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+1,(vlSelf->ysyx_24100006_cpu__DOT__IM__DOT__i),32);
    bufp->fullIData(oldp+2,(vlSelf->ysyx_24100006_cpu__DOT__registerfile__DOT__i),32);
    bufp->fullIData(oldp+3,(vlSelf->ysyx_24100006_cpu__DOT__pc),32);
    bufp->fullIData(oldp+4,(((IData)(4U) + vlSelf->ysyx_24100006_cpu__DOT__pc)),32);
    bufp->fullIData(oldp+5,(vlSelf->ysyx_24100006_cpu__DOT__instruction),32);
    ...
    bufp->fullCData(oldp+7,((0x1fU & (vlSelf->ysyx_24100006_cpu__DOT__instruction 
                                      >> 0x14U))),5);
    bufp->fullCData(oldp+8,((0x1fU & (vlSelf->ysyx_24100006_cpu__DOT__instruction 
                                      >> 7U))),5);
    ...
    bufp->fullIData(oldp+10,(vlSelf->ysyx_24100006_cpu__DOT__registerfile__DOT__rf
                             [(0x1fU & (vlSelf->ysyx_24100006_cpu__DOT__instruction 
                                        >> 0x14U))]),32);
    bufp->fullIData(oldp+11,((((- (IData)((vlSelf->ysyx_24100006_cpu__DOT__instruction 
                                           >> 0x1fU))) 
    ...
    bufp->fullIData(oldp+46,(vlSelf->result),32);
    bufp->fullIData(oldp+47,(vlSelf->x_pc),32);
    bufp->fullBit(oldp+48,(1U));
    bufp->fullCData(oldp+49,(vlSelf->ysyx_24100006_cpu__DOT__rd),5);
