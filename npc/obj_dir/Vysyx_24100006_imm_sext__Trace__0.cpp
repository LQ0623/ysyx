...
void Vysyx_24100006_imm_sext___024root__trace_chg_sub_0(Vysyx_24100006_imm_sext___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgCData(oldp+0,(vlSelf->ysyx_24100006_MuxKeyInternal__DOT__pair_list[0]),2);
        bufp->chgCData(oldp+1,(vlSelf->ysyx_24100006_MuxKeyInternal__DOT__pair_list[1]),2);
        bufp->chgBit(oldp+2,(vlSelf->ysyx_24100006_MuxKeyInternal__DOT__key_list[0]));
        bufp->chgBit(oldp+3,(vlSelf->ysyx_24100006_MuxKeyInternal__DOT__key_list[1]));
        bufp->chgBit(oldp+4,(vlSelf->ysyx_24100006_MuxKeyInternal__DOT__data_list[0]));
        bufp->chgBit(oldp+5,(vlSelf->ysyx_24100006_MuxKeyInternal__DOT__data_list[1]));
        bufp->chgBit(oldp+6,(vlSelf->ysyx_24100006_MuxKeyInternal__DOT__lut_out));
        bufp->chgBit(oldp+7,(vlSelf->ysyx_24100006_MuxKeyInternal__DOT__hit));
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+8,(vlSelf->ysyx_24100006_cpu__DOT__pc),32);
        bufp->chgIData(oldp+9,(((IData)(4U) + vlSelf->ysyx_24100006_cpu__DOT__pc)),32);
    ...
    bufp->chgBit(oldp+44,(vlSelf->key));
    bufp->chgBit(oldp+45,(vlSelf->default_out));
    bufp->chgCData(oldp+46,(vlSelf->lut),4);
    bufp->chgBit(oldp+47,(vlSelf->clk));
    bufp->chgBit(oldp+48,(vlSelf->reset));
    bufp->chgIData(oldp+49,(vlSelf->instruction),32);
    bufp->chgIData(oldp+50,(vlSelf->result),32);
    bufp->chgIData(oldp+51,(vlSelf->x_pc),32);
    bufp->chgCData(oldp+52,((0x1fU & (vlSelf->instruction 
                                      >> 0xfU))),5);
    bufp->chgCData(oldp+53,((0x1fU & (vlSelf->instruction 
                                      >> 0x14U))),5);
    bufp->chgIData(oldp+54,(vlSelf->ysyx_24100006_cpu__DOT__registerfile__DOT__rf
                            [(0x1fU & (vlSelf->instruction 
                                       >> 0xfU))]),32);
    bufp->chgIData(oldp+55,((((- (IData)((vlSelf->instruction 
                                          >> 0x1fU))) 
