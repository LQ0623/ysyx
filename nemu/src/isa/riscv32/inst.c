...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div_r  , Rt, R(rd) = (src2 == 0)? (int32_t)(-1):(word_t)((int32_t)src1 / (int32_t)src2));
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , Rt, R(rd) = (src2 == 0)? (uint32_t)(int32_t)src1:(int32_t)src1 % (int32_t)src2);
